class Constants #lx:namespace lexedo.games.Cofb {
	#lx:const
		...
		TYLE_GOODS_TURN = 1,
		TYLE_GOODS_INGAME = 2,
		TYLE_GOODS_INGAMER = 3,
		TYLE_GOODS_SALES = 4,
		TYLE_ADVANTAGE_CUBE = 5,
		TYLE_ADVANTAGE_FORSALE = 6,
		TYLE_ADVANTAGE_WAITING = 7,
		TYLE_ADVANTAGE_LOCATED = 8,
		TYLE_SILVER = 9,
		TYLE_WORKER = 10,
		TYLE_CUBE_GAME = 11,
		TYLE_CUBE_GAMER = 12,
		TYLE_CUBE_WAITING = 13,
		TYLE_BONUS_INGAME = 14,
		TYLE_BONUS_INGAMER = 15,
		TYLE_GAMER_SEQUENCE = 16,
		TYLE_GAMER_POINTS = 17,
		TYLE_COUNTER = 18,
